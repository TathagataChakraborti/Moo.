...
(:goal
	(and
		...
		(applied_schema s1 carrying_capacity)
		...
		(apply_type s1 moose_births exponential_growth)
		(apply_equation s1 moose_births exponential_growth)
		(apply_type s1 moose_birth_probability exponential_growth)
		(apply_type s1 moose_deaths exponential_decay)
		(apply_equation s1 moose_deaths exponential_decay)
		(apply_type s1 moose_capacity carrying_capacity)
		(apply_type_double s1 moose_death_probability exponential_decay carrying_capacity)
		(apply_equation_double s1 moose_death_probability exponential_decay carrying_capacity)
		(apply_type_double s1 moose_population exponential_decay exponential_growth)
		(apply_equation_double s1 moose_population exponential_decay exponential_growth)
	)
)
)
