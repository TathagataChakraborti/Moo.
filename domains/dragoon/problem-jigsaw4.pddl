...
(applied_schema s5 linear)
(applied_schema s5 exponential)
(applied_schema s5 extended_exponential)
(applied_schema s5 capacity)
(applied_schema s5 interaction)
(applied_schema s5 epidemic)
)
)
