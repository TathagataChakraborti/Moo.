...
(applied_concept s5 linear)
(applied_concept s5 exponential)
(applied_concept s5 extended_exponential)
(applied_concept s5 capacity)
(applied_concept s5 interaction)
(applied_concept s5 epidemic)
)
)
