...
(applied_schema s3 linear)
(applied_schema s3 exponential)
(applied_schema s3 extended_exponential)
(applied_schema s3 capacity)
(applied_schema s3 interaction)
(applied_schema s3 epidemic)
(applied_schema s4 linear)
(applied_schema s4 exponential)
(applied_schema s4 extended_exponential)
(applied_schema s4 capacity)
(applied_schema s4 interaction)
(applied_schema s4 epidemic)
)
)
